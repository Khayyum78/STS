...
public class ProductResponse {
    private Long id; private String name; private String sku; private Integer quantity; private Double price;
    public ProductResponse() {}
    public ProductResponse(Long id, String name, String sku, Integer quantity, Double price) {
